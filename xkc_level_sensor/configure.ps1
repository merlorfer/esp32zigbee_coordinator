...
New-Item -ItemType Directory -Force -Path "D:\Programing\esp-idf\projects\AiAgent\CLCode01\xkc_level_sensor\build" | Out-Null
Set-Location "D:\Programing\esp-idf\projects\AiAgent\CLCode01\xkc_level_sensor\build"
cmake -G Ninja -DIDF_TARGET=esp32c6 -DPYTHON_DEPS_CHECKED=1 .. 2>&1 | Tee-Object -FilePath "D:\Programing\esp-idf\projects\AiAgent\CLCode01\xkc_level_sensor\configure_log.txt"
